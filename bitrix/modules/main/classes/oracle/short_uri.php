	...
	extends CBXAllShortUri
{
	public static function Add($arFields)
	{
		...
		$taskId = $arFields["ID"] = $DB->NextID("SQ_B_SHORT_URI");
			...
			foreach ($arFilter as $key => $val)
			{
				...
				switch($key)
				{
					...
					case "STATUS":
						...
						break;
					case "MODIFIED_1":
						$arWherePart[] = "U.MODIFIED >= TO_DATE('".FmtDate($val, "D.M.Y")." 00:00:00', 'dd.mm.yyyy hh24:mi:ss')";
						break;
					case "MODIFIED_2":
						$arWherePart[] = "U.MODIFIED <= TO_DATE('".FmtDate($val, "D.M.Y")." 23:59:59', 'dd.mm.yyyy hh24:mi:ss')";
						break;
					case "LAST_USED_1":
						$arWherePart[] = "U.LAST_USED >= TO_DATE('".FmtDate($val, "D.M.Y")." 00:00:00', 'dd.mm.yyyy hh24:mi:ss')";
						break;
					case "LAST_USED_2":
						$arWherePart[] = "U.LAST_USED <= TO_DATE('".FmtDate($val, "D.M.Y")." 23:59:59', 'dd.mm.yyyy hh24:mi:ss')";
						break;
					case "NUMBER_USED":
