			...
			foreach ($arFilter as $key => $val)
			{
				...
				switch($key)
				{
					...
					case "URI_CRC":
						...
						break;
					case "SHORT_URI":
						$arWherePart[] = "CAST(U.SHORT_URI AS varbinary(250)) = CAST('".$DB->ForSQL($val)."' AS varbinary(250))";
						break;
					case "SHORT_URI_CRC":
					...
					case "STATUS":
						...
						break;
					case "MODIFIED_1":
						$arWherePart[] = "U.MODIFIED >= ".$DB->CharToDateFunction($val, "SHORT");
						break;
					case "MODIFIED_2":
						$arWherePart[] = "U.MODIFIED < dateadd(day, 1, ".$DB->CharToDateFunction($val, "SHORT").")";
						break;
					case "LAST_USED_1":
						$arWherePart[] = "U.LAST_USED >= ".$DB->CharToDateFunction($val, "SHORT");
						break;
					case "LAST_USED_2":
						$arWherePart[] = "U.LAST_USED < dateadd(day, 1, ".$DB->CharToDateFunction($val, "SHORT").")";
						break;
					case "NUMBER_USED":
