...
GOALTER TABLE B_VOTE_CHANNEL ADD CONSTRAINT DF_B_VOTE_CHANNEL_VOTE_SINGLE DEFAULT 'Y' FOR VOTE_SINGLE
GO
...
GO
ALTER TABLE B_VOTE_ANSWER ADD CONSTRAINT DF_B_VOTE_ANSWER_MESSAGE_TYPE DEFAULT 'html' FOR MESSAGE_TYPE
GO
...
GO
ALTER TABLE B_VOTE_ATTACHED_OBJECT ADD CONSTRAINT PK_B_VOTE_ATTACHED_OBJECT PRIMARY KEY (ID)
GO
