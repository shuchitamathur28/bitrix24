...
class CVoteEvent extends CAllVoteEvent
{
	...
	public static function GetUserAnswerStat($arSort = array(), $arFilter = array(), $arParams = array())
	{
		...
		if (isset($arFilter["bGetVoters"]))
		{
			...
			{
				$strSql = "SELECT VEQ.QUESTION_ID, VEA.ANSWER_ID, VU.AUTH_USER_ID, COUNT(VEA.ID) as COUNTER, \n\t".
				...
				"ORDER BY ".(IsModuleInstalled("intranet") ? "RV.VOTE_WEIGHT DESC NULLS LAST, RANK DESC NULLS LAST" : "RANK DESC NULLS LAST, RV.VOTE_WEIGHT DESC NULLS LAST").", VU.AUTH_USER_ID ASC";
