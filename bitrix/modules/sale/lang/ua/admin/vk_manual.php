...
$MESS["SALE_VK_MANUAL__CONNECTION_TITLE_2"] = "Ідентифікатор групи";
$MESS["SALE_VK_MANUAL__CONNECTION_7"] = "Для налаштування з'єднання необхідно знати ідентифікатор вашої групи. Перейдіть до \"Управління спільнотами\".";
$MESS["SALE_VK_MANUAL__CONNECTION_7a"] = "Якщо ви ще не змінили адресу співтовариства на більш гарну &mdash; скопіюйте з поля \"Адреса сторінки\" цифри після слова \"public\".
Якщо адресу вже змінено &mdash; ID спільноти можна вичленити з адресного рядка (див. малюнок).";
$MESS["SALE_VK_MANUAL__CONNECTION_7b"] = "<b>Скопіюйте цей код</b> у відповідне поле в налаштуваннях експорту на сайті.";
$MESS["SALE_VK_MANUAL__CONNECTION_7c"] = "<i>При збереженні до ідентифікатора буде додано знак \"мінус\". Це особливість, необхідна для ВКонтакті.</i>";
$MESS["SALE_VK_MANUAL__CONNECTION_8b"] = "Найімовірніше, ви неправильно вказали \"ID додатка\" або \"Захищений ключ\" в налаштуваннях експорту або \"Адреса сайту\" або \"Базовий домен\" в налаштуваннях додатку.";
$MESS["SALE_VK_MANUAL__CONNECTION_9"] = "Якщо ви отримали ключ доступу &nbsp; <b>з'єднання з ВКонтакті налаштоване</b>. Переходимо далі.";
?>