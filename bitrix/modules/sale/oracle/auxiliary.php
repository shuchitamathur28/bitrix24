...
//				"ITEM_MD5" => array("FIELD" => "A.ITEM_MD5", "TYPE" => "string"),
	...
	function DeleteByTime($periodLength, $periodType)
	{
		...
		return $DB->Query("DELETE FROM b_sale_auxiliary WHERE DATE_INSERT < TO_DATE('".Date("d.m.Y H:i:s", $deleteVal)."', 'DD.MM.YYYY HH24:MI:SS') ", true);
	}
	...
	function Add($arFields)
	{
		...
		$ID = IntVal($DB->NextID("SQ_SALE_AUXILIARY"));

		$strSql =
			"INSERT INTO b_sale_auxiliary(ID, ".$arInsert[0].") ".
