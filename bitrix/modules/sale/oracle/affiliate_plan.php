...
class CSaleAffiliatePlan extends CAllSaleAffiliatePlan
{
	...
	function Add($arFields)
	{
		...
		$ID = IntVal($DB->NextID("SQ_SALE_AFFILIATE_PLAN"));

		$strSql =
			"INSERT INTO b_sale_affiliate_plan(ID, ".$arInsert[0].", TIMESTAMP_X) ".
	...
	function Update($ID, $arFields)
	{
		...
		$strSql = "UPDATE b_sale_affiliate_plan SET ".$strUpdate.", TIMESTAMP_X = ".$DB->GetNowFunction()." WHERE ID = ".$ID." ";
