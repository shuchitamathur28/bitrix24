...
class CSaleUserCards extends CAllSaleUserCards
{
	...
	function Add($arFields)
	{
		...
		{
			$IDENTITY_INSERT = "ON";
			$DB->Query("SET IDENTITY_INSERT b_sale_user_cards ON", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		$strSql =
		...
		{
			$IDENTITY_INSERT="OFF";
			$DB->Query("SET IDENTITY_INSERT b_sale_user_cards OFF", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		$ID = IntVal($DB->LastID());
	...
	function Update($ID, $arFields)
	{
		...
		$arBinds = Array();
		if (is_set($arFields, "CARD_NUM"))
			$arBinds["CARD_NUM"] = $arFields["CARD_NUM"];
