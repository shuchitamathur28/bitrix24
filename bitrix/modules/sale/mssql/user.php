...
class CSaleUserAccount extends CAllSaleUserAccount
{
	...
	function Add($arFields)
	{
		...
		{
			$IDENTITY_INSERT = "ON";
			$DB->Query("SET IDENTITY_INSERT b_sale_user_account ON", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		...
		{
			$IDENTITY_INSERT="OFF";
			$DB->Query("SET IDENTITY_INSERT b_sale_user_account OFF", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		$ID = (int)$DB->LastID();
