...
class CSaleOrderUserPropsValue extends CAllSaleOrderUserPropsValue
{
	...
	function Add($arFields)
	{
		...
		{
			$IDENTITY_INSERT = "ON";
			$DB->Query("SET IDENTITY_INSERT b_sale_user_props_value ON", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		$strSql = 
		...
		{
			$IDENTITY_INSERT="OFF";
			$DB->Query("SET IDENTITY_INSERT b_sale_user_props_value OFF", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
