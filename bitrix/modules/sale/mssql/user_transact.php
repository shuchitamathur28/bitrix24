...
class CSaleUserTransact extends CAllSaleUserTransact
{
	...
	function Add($arFields)
	{
		...
		{
			$IDENTITY_INSERT = "ON";
			$DB->Query("SET IDENTITY_INSERT b_sale_user_transact ON", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		$strSql =
		...
		{
			$IDENTITY_INSERT="OFF";
			$DB->Query("SET IDENTITY_INSERT b_sale_user_transact OFF", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		$ID = IntVal($DB->LastID());
	...
	function Update($ID, $arFields)
	{
		...
		$arBinds = Array();
		if (is_set($arFields, "NOTES"))
			$arBinds["NOTES"] = $arFields["NOTES"];
