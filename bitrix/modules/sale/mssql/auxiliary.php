...
//				"ITEM_MD5" => array("FIELD" => "A.ITEM_MD5", "TYPE" => "string"),
	...
	function DeleteByTime($periodLength, $periodType)
	{
		...
		return $DB->Query("DELETE FROM b_sale_auxiliary WHERE DATE_INSERT < convert (datetime, '".date("Y-m-d H:i:s", $deleteVal)."', 120) ", true, "File: ".__FILE__."<br>Line: ".__LINE__);
	}
	...
	function Add($arFields)
	{
		...
		{
			$IDENTITY_INSERT="ON";
			$DB->Query("SET IDENTITY_INSERT b_sale_auxiliary ON", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		...
		{
			$IDENTITY_INSERT="OFF";
			$DB->Query("SET IDENTITY_INSERT b_sale_auxiliary OFF", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
