...
class CSalePersonType extends CAllSalePersonType
{
	...
	function Add($arFields)
	{
		...
		{
			$IDENTITY_INSERT = "ON";
			$DB->Query("SET IDENTITY_INSERT b_sale_person_type ON", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		$strSql =
		...
		{
			$IDENTITY_INSERT="OFF";
			$DB->Query("SET IDENTITY_INSERT b_sale_person_type OFF", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		$ID = IntVal($DB->LastID());
