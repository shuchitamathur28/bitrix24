...
class CSaleGroupAccessToFlag extends CAllSaleGroupAccessToFlag
{
	...
	function Add($arFields)
	{
		...
		{
			$IDENTITY_INSERT = "ON";
			$DB->Query("SET IDENTITY_INSERT b_sale_order_flags2group ON", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		$strSql =
		...
		{
			$IDENTITY_INSERT="OFF";
			$DB->Query("SET IDENTITY_INSERT b_sale_order_flags2group OFF", false, "File: ".__FILE__."<br>Line: ".__LINE__);
		}
		$ID = IntVal($DB->LastID());
