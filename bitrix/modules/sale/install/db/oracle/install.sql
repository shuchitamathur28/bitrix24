...
/
CREATE SEQUENCE SQ_B_SALE_FUSER INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
...
(
	...
	VAT_RATE NUMBER(18, 4) DEFAULT '0.00' NULL,
...
/
CREATE INDEX IXS_BASKET_SET_PARENT_ID ON B_SALE_BASKET(SET_PARENT_ID)
/
...
(
	...
	IS_RECURRING CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
...
/
CREATE SEQUENCE SQ_B_SALE_ORDER INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
...
/
CREATE INDEX IX_BSO_DATE_ALLOW_DELIVERY ON B_SALE_ORDER (DATE_ALLOW_DELIVERY)
/
CREATE INDEX IX_BSO_ALLOW_DELIVERY ON B_SALE_ORDER (ALLOW_DELIVERY)
/
CREATE INDEX IX_BSO_DATE_CANCELED ON B_SALE_ORDER (DATE_CANCELED)
/
CREATE INDEX IX_BSO_CANCELED ON B_SALE_ORDER (CANCELED)
/
CREATE INDEX IX_BSO_DATE_PAYED ON B_SALE_ORDER (DATE_PAYED)
/
CREATE INDEX IX_BSO_DATE_INSERT ON B_SALE_ORDER (DATE_INSERT)
/
CREATE INDEX IX_BSO_DATE_PAY_BEFORE ON B_SALE_ORDER (DATE_PAY_BEFORE)
/
...
BEGIN
	IF :NEW.ID IS NULL THEN
 		SELECT SQ_B_SALE_ORDER.NEXTVAL INTO :NEW.ID FROM dual;
	END IF;
END;
/
...
(
	...
	IS_CASH CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
	PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_PAY_SYSTEM_ACTION START WITH 12 INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
...
(
	COMPANY_ID NUMBER(18) NOT NULL,
	SERVICE_ID NUMBER(18) NOT NULL,
	SERVICE_TYPE NUMBER(18) NOT NULL,
...
(
	...
	LAST_LEVEL_DISCOUNT CHAR(1 CHAR) DEFAULT 'N',
	VERSION NUMBER(18) DEFAULT 1 NOT NULL,
	CONDITIONS CLOB NULL,
	UNPACK CLOB NULL,
	ACTIONS CLOB NULL,
	APPLICATION CLOB NULL,
	PREDICTION_TEXT CLOB null,
	PREDICTIONS CLOB null,
	PREDICTIONS_APP CLOB null,
	USE_COUPONS CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
	HAS_INDEX CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
...
/
CREATE INDEX IX_S_D_COUPON ON B_SALE_DISCOUNT_COUPON(COUPON)
/
...
(
	...
	ACTION_BLOCK_LIST CLOB NULL,
	APPLY_BLOCK_COUNTER NUMBER(18) DEFAULT 0 NOT NULL,
	PRIMARY KEY (ID)
)
/
...
(
	...
	ORDER_ID  NUMBER(18) NOT NULL,
	APPLY_BLOCK_COUNTER NUMBER(18) DEFAULT 0 NOT NULL,
	ORDER_ROUND CHAR(1 CHAR) NOT NULL,
	ENTITY_TYPE NUMBER(18) NOT NULL,
	ENTITY_ID NUMBER(18) NOT NULL,
	ENTITY_VALUE VARCHAR2(255 CHAR) NULL,
	APPLY CHAR(1 CHAR) NOT NULL,
	ROUND_RULE CLOB NOT NULL,
	PRIMARY KEY (ID)
)
/
CREATE INDEX IX_SALE_ORDER_ROUND_ORD ON B_SALE_ORDER_ROUND(ORDER_ID)
/
CREATE SEQUENCE SQ_B_SALE_ORDER_ROUND INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_ORDER_RND_INSERT
BEFORE INSERT
	ON B_SALE_ORDER_ROUND
FOR EACH ROW
	BEGIN
		IF :NEW.ID IS NULL THEN
			SELECT SQ_B_SALE_ORDER_ROUND.NEXTVAL INTO :NEW.ID FROM dual;
		END IF;
	END;
/
...
/
CREATE INDEX IX_S_DIXE_O_1 ON B_SALE_D_IX_ELEMENT(ELEMENT_ID, DISCOUNT_ID)
/
CREATE SEQUENCE SQ_SALE_D_IX_ELEMENT INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_D_IX_ELEMENT_INSERT
BEFORE INSERT
...
/
CREATE INDEX IX_S_DIXS_O_1 ON B_SALE_D_IX_SECTION(SECTION_ID, DISCOUNT_ID)
/
CREATE SEQUENCE SQ_SALE_D_IX_SECTION INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_D_IX_SECTION_INSERT
BEFORE INSERT
...
(
	...
	VALUE_MONEY   NUMBER(18,4)  NOT NULL,
...
(
	...
	PARAMS CLOB NULL,
	STATUS_ID VARCHAR2(2 CHAR) NOT NULL,
	PRICE_DELIVERY NUMBER(18,4) DEFAULT 0.0000 NULL,
	DISCOUNT_PRICE NUMBER(18,4) DEFAULT 0.0000 NULL,
	BASE_PRICE_DELIVERY NUMBER(18,4) DEFAULT 0.0000 NULL,
	...
	ID_1C VARCHAR2(36 CHAR) NULL,
	VERSION_1C VARCHAR2(15 CHAR) NULL,
	EXTERNAL_DELIVERY CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
	UPDATED_1C CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
	PRIMARY KEY (ID)
)
/
...
/
CREATE INDEX IX_BSOD_DATE_ALLOW_DELIVERY ON B_SALE_ORDER_DELIVERY(DATE_ALLOW_DELIVERY)
/
CREATE INDEX IX_BSOD_ALLOW_DELIVERY ON B_SALE_ORDER_DELIVERY(ALLOW_DELIVERY)
/
CREATE INDEX IX_BSOD_DATE_CANCELED ON B_SALE_ORDER_DELIVERY(DATE_CANCELED)
/
CREATE INDEX IX_BSOD_CANCELED ON B_SALE_ORDER_DELIVERY(CANCELED)
/
CREATE UNIQUE INDEX IXS_DLV_ACCOUNT_NUMBER ON B_SALE_ORDER_DELIVERY(ACCOUNT_NUMBER)
/
...
CREATE TABLE B_SALE_ORDER_DELIVERY_REQ (
  ...
  DELIVERY_LOCATION VARCHAR2(50 CHAR) NULL,
  PARAMS CLOB NULL,
  SHIPMENT_ID NUMBER (18) NULL,
  PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_ORDER_DELIVERY_REQ START WITH 1 INCREMENT BY 1 NOMINVALUE NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE INDEX IX_ORDER_ID ON B_SALE_ORDER_DELIVERY_REQ(ORDER_ID)
/
CREATE INDEX IX_SHIPMENT_ID ON B_SALE_ORDER_DELIVERY_REQ(SHIPMENT_ID)
/
...
CREATE TABLE B_SALE_ORDER_HISTORY (
	...
	DATE_CANCELED DATE NULL,
	REASON_CANCELED VARCHAR2(255 CHAR) NULL,
	STATUS_ID VARCHAR2(2 CHAR) NULL,
...
/
CREATE INDEX IX_SOP_ORDER_ID ON B_SALE_ORDER_PROCESSING (ORDER_ID)
/
...
(
	...
	DESCRIPTION VARCHAR2(255 CHAR) NULL,
	SETTINGS CLOB NULL,
	CATALOG_SECTION_TAB_CLASS_NAME VARCHAR2(255 CHAR) NULL,
	CLASS VARCHAR2(255 CHAR) NULL,
	PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_TP INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_TP_INSERT
BEFORE INSERT
ON B_SALE_TP
FOR EACH ROW
BEGIN
	IF :NEW.ID IS NULL THEN
		SELECT SQ_B_SALE_TP.NEXTVAL INTO :NEW.ID FROM dual;
	END IF;
END;
/
CREATE UNIQUE INDEX IX_BSTP_CODE ON B_SALE_TP(CODE)
/
...
(
	...
	LOCATION_ID VARCHAR2(128 CHAR) NULL,
...
(
	...
	PROVIDER_VALUE VARCHAR(2000 CHAR) NULL,
...
/
CREATE SEQUENCE SQ_B_SALE_SERVICE_RSTR INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
...
END;
/
CREATE INDEX IX_BSSR_SERVICE_ID ON B_SALE_SERVICE_RSTR (SERVICE_ID)
/
...
(
	...
	ALLOW_EDIT_SHIPMENT CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
	PRIMARY KEY (ID)
)
/
...
/
CREATE INDEX IX_S_O_DB_BASKET_ID ON B_SALE_ORDER_DLV_BASKET(BASKET_ID)
/
...
CREATE TABLE B_SALE_ORDER_PAYMENT(
	...
	PS_STATUS CHAR(1 CHAR) NULL,
	PS_STATUS_CODE VARCHAR2(255 CHAR) NULL,
	PS_STATUS_DESCRIPTION VARCHAR2(512 CHAR) NULL,
	PS_INVOICE_ID VARCHAR2(250 CHAR) NULL,
	PS_STATUS_MESSAGE VARCHAR2(250 CHAR) NULL,
	...
	PRICE_COD DECIMAL(18,4) DEFAULT 0 NOT NULL,
	CURRENCY CHAR(3 CHAR) NOT NULL,
  ...
  EMP_MARKED_ID NUMBER(18) NULL,
	ID_1C VARCHAR2(36 CHAR) NULL,
	VERSION_1C VARCHAR2(15 CHAR) NULL,
	EXTERNAL_PAYMENT CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
	UPDATED_1C CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
	PRIMARY KEY (ID)
)
/
...
/
CREATE UNIQUE INDEX IXS_PAY_ACCOUNT_NUMBER ON B_SALE_ORDER_PAYMENT(ACCOUNT_NUMBER)
/
CREATE INDEX IX_BSOP_DATE_PAID ON B_SALE_ORDER_PAYMENT(DATE_PAID)
/
CREATE INDEX IX_BSOP_PAID ON B_SALE_ORDER_PAYMENT(PAID)
/
...
(
	ID NUMBER(18) NOT NULL,
	ENTITY_ID NUMBER(18) NOT NULL,
	VALUE_EXTERNAL VARCHAR2(100 CHAR) NOT NULL,
	VALUE_INTERNAL VARCHAR2(100 CHAR) NOT NULL,
	PARAMS CLOB NULL,
	PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_TP_MAP INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_TP_MAP_INSERT
BEFORE INSERT
ON B_SALE_TP_MAP
FOR EACH ROW
BEGIN
	IF :NEW.ID IS NULL THEN
		SELECT SQ_B_SALE_TP_MAP.NEXTVAL INTO :NEW.ID FROM dual;
	END IF;
END;
/
CREATE UNIQUE INDEX IX_BSTPM__C_V_V ON B_SALE_TP_MAP(ENTITY_ID, VALUE_EXTERNAL, VALUE_INTERNAL)
/

CREATE TABLE B_SALE_TP_MAP_ENTITY
(
	ID NUMBER(18) NOT NULL,
	TRADING_PLATFORM_ID NUMBER(18) NOT NULL,
	CODE VARCHAR2(255 CHAR) NOT NULL,
	PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_TP_MAP_ENTITY INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_TP_MAP_ENTITY_INSERT
BEFORE INSERT
ON B_SALE_TP_MAP_ENTITY
FOR EACH ROW
BEGIN
	IF :NEW.ID IS NULL THEN
		SELECT SQ_B_SALE_TP_MAP_ENTITY.NEXTVAL INTO :NEW.ID FROM dual;
	END IF;
END;
/
CREATE UNIQUE INDEX IX_STPME_TPC_C ON B_SALE_TP_MAP_ENTITY(TRADING_PLATFORM_ID, CODE)
/
...
(
	...
	"LEVEL" NUMBER(18) NOT NULL,
	CONDITION_ID_VALUES VARCHAR2(255 CHAR) NOT NULL,
	CONDITION_ID_DEFINITION_URL VARCHAR2(255 CHAR) NOT NULL,
	ITEM_SPECIFIC_ENABLED CHAR(1 CHAR) NOT NULL,
	VARIATIONS_ENABLED CHAR(1 CHAR) NOT NULL,
	PRODUCT_CREATION_ENABLED CHAR(1 CHAR) NOT NULL,
	LAST_UPDATE DATE NOT NULL,
	PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_TP_EBAY_CAT INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_TP_EBAY_CAT_INSERT
BEFORE INSERT
ON B_SALE_TP_EBAY_CAT
FOR EACH ROW
	BEGIN
		IF :NEW.ID IS NULL THEN
			SELECT SQ_B_SALE_TP_EBAY_CAT.NEXTVAL INTO :NEW.ID FROM dual;
		END IF;
	END;
/
...
(
	...
	REQUIRED CHAR(1 CHAR) NOT NULL,
	MIN_VALUES NUMBER(18) NOT NULL,
	MAX_VALUES NUMBER(18) NOT NULL,
	SELECTION_MODE VARCHAR2 (255 CHAR) NOT NULL,
	ALLOWED_AS_VARIATION CHAR(1 CHAR) NOT NULL,
	DEPENDENCY_NAME VARCHAR2(255 CHAR) NOT NULL,
	DEPENDENCY_VALUE VARCHAR2(255 CHAR) NOT NULL,
	HELP_URL VARCHAR2(255 CHAR) NOT NULL,
	PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_TP_EBAY_CAT_VAR INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_TP_EBAY_CAT_VAR_INSERT
BEFORE INSERT
ON B_SALE_TP_EBAY_CAT_VAR
FOR EACH ROW
	BEGIN
		IF :NEW.ID IS NULL THEN
			SELECT SQ_B_SALE_TP_EBAY_CAT_VAR.NEXTVAL INTO :NEW.ID FROM dual;
		END IF;
	END;
/
...
(
	ID NUMBER(18) NOT NULL,
	FEED_TYPE VARCHAR2(50 CHAR) NOT NULL,
	DATA CLOB NOT NULL,
	PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_TP_EBAY_FQ INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_TP_EBAY_FQ_INSERT
BEFORE INSERT
ON B_SALE_TP_EBAY_FQ
FOR EACH ROW
	BEGIN
		IF :NEW.ID IS NULL THEN
			SELECT SQ_B_SALE_TP_EBAY_FQ.NEXTVAL INTO :NEW.ID FROM dual;
		END IF;
	END;
/
...
(
	...
	PROCESSING_REQUEST_ID VARCHAR2(50 CHAR) NULL,
	PROCESSING_RESULT VARCHAR2(100 CHAR) NULL,
	RESULTS CLOB NULL,
	IS_SUCCESS CHAR(1 CHAR) NULL
)
/
CREATE SEQUENCE SQ_B_SALE_TP_EBAY_FR INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_TP_EBAY_FR_INSERT
BEFORE INSERT
ON B_SALE_TP_EBAY_FR
FOR EACH ROW
	BEGIN
		IF :NEW.ID IS NULL THEN
			SELECT SQ_B_SALE_TP_EBAY_FR.NEXTVAL INTO :NEW.ID FROM dual;
		END IF;
	END;
/
...
(
	...
	ORDER_ID NUMBER(18) NOT NULL,
	TRADING_PLATFORM_ID NUMBER(18) NOT NULL,
	EXTERNAL_ORDER_ID VARCHAR2(100 CHAR) NOT NULL,
	PARAMS CLOB NULL
)
/
CREATE SEQUENCE SQ_B_SALE_TP_ORDER INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_TP_ORDER_INSERT
BEFORE INSERT
ON B_SALE_TP_ORDER
FOR EACH ROW
	BEGIN
		IF :NEW.ID IS NULL THEN
			SELECT SQ_B_SALE_TP_ORDER.NEXTVAL INTO :NEW.ID FROM dual;
		END IF;
	END;
/
CREATE UNIQUE INDEX IX_BSTPO_O_T_E ON B_SALE_TP_ORDER(ORDER_ID, TRADING_PLATFORM_ID, EXTERNAL_ORDER_ID)
/
...
(
	ID NUMBER(18) NOT NULL,
	DISCOUNT_ID NUMBER(18) NOT NULL,
	ELEMENT_ID NUMBER(18),
	SECTION_ID NUMBER(18),
	MAIN_PRODUCT_SECTION_ID NUMBER(18)
)
/
CREATE SEQUENCE SQ_B_SALE_GIFT_RELATED_DATA INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_S_GIFT_RELATED_DATA_INSERT
BEFORE INSERT
ON B_SALE_GIFT_RELATED_DATA
FOR EACH ROW
	BEGIN
		IF :NEW.ID IS NULL THEN
			SELECT SQ_B_SALE_GIFT_RELATED_DATA.NEXTVAL INTO :NEW.ID FROM dual;
		END IF;
	END;
/
CREATE INDEX IX_S_GRD_O_1 ON B_SALE_GIFT_RELATED_DATA (DISCOUNT_ID)
/
CREATE INDEX IX_S_GRD_O_2 ON B_SALE_GIFT_RELATED_DATA (MAIN_PRODUCT_SECTION_ID)
/
...
/
CREATE SEQUENCE SQ_B_SALE_PAY_SYSTEM_ES INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_PAY_SYSTEM_ES_INSERT
BEFORE INSERT
ON B_SALE_DELIVERY_ES
FOR EACH ROW
BEGIN
...
END;
/
CREATE INDEX IX_BSPS_ES_PAY_SYSTEM_ID ON B_SALE_PAY_SYSTEM_ES(PAY_SYSTEM_ID)
/
...
/
CREATE SEQUENCE SQ_B_SALE_ORDER_PAYMENT_ES INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER BSO_PAYMENT_ES_INSERT
BEFORE INSERT
...
END;
/
CREATE INDEX IX_BSOP_ES_PAYMENT_ID ON B_SALE_ORDER_PAYMENT_ES (PAYMENT_ID)
/
CREATE INDEX IX_BSOP_ES_EXTRA_SERVICE_ID ON B_SALE_ORDER_PAYMENT_ES (EXTRA_SERVICE_ID)
/
...
/
CREATE SEQUENCE SQ_B_SALE_PAY_SYSTEM_ERR_LOG INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_PAY_SYSTEM_LOG_INSERT
BEFORE INSERT
...
CREATE TABLE B_SALE_HDALN(
	LOCATION_ID NUMBER(18) NOT NULL,
	LEFT_MARGIN NUMBER(18) NOT NULL,
	RIGHT_MARGIN NUMBER(18) NOT NULL,
	NAME VARCHAR(100 CHAR) NOT NULL,
	PRIMARY KEY (LOCATION_ID)
)
/
CREATE INDEX IX_BSHDALN_NAME ON B_SALE_HDALN (NAME)
/
...
(
	ID NUMBER(18) NOT NULL,
	ORDER_ID NUMBER(18) NOT NULL,
	ENTITY_TYPE VARCHAR2(25 CHAR) NOT NULL,
	ENTITY_ID NUMBER(18) NOT NULL,
...
/
CREATE SEQUENCE SQ_SALE_ENTITY_MARKER INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_ENTITY_MARKER_INSERT
BEFORE INSERT
ON B_SALE_ENTITY_MARKER
FOR EACH ROW
BEGIN
	IF :NEW.ID IS NULL THEN
		SELECT SQ_SALE_ENTITY_MARKER.NEXTVAL INTO :NEW.ID FROM dual;
	END IF;
END;
/
CREATE INDEX IX_BSEM_TYPE ON B_SALE_ENTITY_MARKER (TYPE)
/
CREATE INDEX IX_BSEM_ENTITY_TYPE ON B_SALE_ENTITY_MARKER (ENTITY_TYPE)
/
...
(
  ...
  VK_SETTINGS CLOB NULL,
  EXPORT_SETTINGS CLOB NULL,
  OAUTH CLOB NULL,
  PROCESS CLOB NULL,
  JOURNAL CLOB NULL,
  PRIMARY KEY (ID)
...
/
CREATE SEQUENCE SQ_B_SALE_TP_VK_PROFILE INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_TP_VK_PROFILE_INSERT
BEFORE INSERT
ON B_SALE_TP_VK_PROFILE
FOR EACH ROW
BEGIN
  IF :NEW.ID IS NULL THEN
    SELECT SQ_B_SALE_TP_VK_PROFILE.NEXTVAL INTO :NEW.ID FROM dual;
  END IF;
END;
/
...
(
  ID NUMBER(18) NOT NULL,
  EXPORT_ID NUMBER(18) NOT NULL,
  ERROR_CODE VARCHAR2(255 CHAR) NULL,
  ITEM_ID VARCHAR2(255 CHAR) NULL,
  ERROR_PARAMS text NULL,
  TIME DATE NULL,
  PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_TP_VK_LOG INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_TP_VK_LOG_INSERT
BEFORE INSERT
ON B_SALE_TP_VK_LOG
FOR EACH ROW
BEGIN
  IF :NEW.ID IS NULL THEN
    SELECT SQ_B_SALE_TP_VK_LOG.NEXTVAL INTO :NEW.ID FROM dual;
  END IF;
END;
/
...
(
  ...
  ID_1C VARCHAR2(36 CHAR) NULL,
	RESPONSIBLE_ID NUMBER(18) NULL,
 	COMPANY_ID NUMBER(18) NULL,
  ORDER_DATA CLOB NULL,
  VERSION NUMBER(3) NOT NULL,
  DATE_ARCHIVED DATE NOT NULL,
	PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_ORDER_ARCHIVE INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_ORDER_ARCHIVE_INSERT
BEFORE INSERT
ON B_SALE_ORDER_ARCHIVE
FOR EACH ROW
BEGIN
	IF :NEW.ID IS NULL THEN
		SELECT SQ_B_SALE_ORDER_ARCHIVE.NEXTVAL INTO :NEW.ID FROM dual;
	END IF;
END;
/
CREATE INDEX IXS_BSOA_USER_ID ON B_SALE_ORDER_ARCHIVE (USER_ID)
/
CREATE INDEX IXS_BSOA_STATUS_ID ON B_SALE_ORDER_ARCHIVE (STATUS_ID)
/
CREATE INDEX IXS_BSOA_DATE_INSERT ON B_SALE_ORDER_ARCHIVE (DATE_INSERT)
/
CREATE INDEX IXS_BSOA_DATE_ARCHIVED ON B_SALE_ORDER_ARCHIVE (DATE_ARCHIVED)
/
CREATE INDEX IXS_BSOA_XML_ID ON B_SALE_ORDER_ARCHIVE (XML_ID)
/
CREATE INDEX IXS_BSOA_ID_1C ON B_SALE_ORDER_ARCHIVE (ID_1C)
/
CREATE INDEX IXS_BSOA_COMPANY_ID ON B_SALE_ORDER_ARCHIVE (COMPANY_ID)
/
CREATE INDEX IXS_BSOA_RESPONSIBLE_ID ON B_SALE_ORDER_ARCHIVE (RESPONSIBLE_ID)
/
CREATE INDEX IXS_BSOA_ORDER_ID ON B_SALE_ORDER_ARCHIVE (ORDER_ID)
/
CREATE INDEX IXS_BSOA_ACCOUNT_NUMBER ON B_SALE_ORDER_ARCHIVE (ACCOUNT_NUMBER)
/
...
(
	...
	MEASURE_CODE NUMBER(18) NULL,
	MEASURE_NAME VARCHAR2(50 CHAR) null,
	BASKET_DATA CLOB NULL,
	PRIMARY KEY (ID)
)
/
CREATE SEQUENCE SQ_B_SALE_BASKET_ARCHIVE INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_BASKET_ARCHIVE_INSERT
BEFORE INSERT
ON B_SALE_BASKET_ARCHIVE
FOR EACH ROW
BEGIN
	IF :NEW.ID IS NULL THEN
		SELECT SQ_B_SALE_BASKET_ARCHIVE.NEXTVAL INTO :NEW.ID FROM dual;
	END IF;
END;
/
CREATE INDEX IXS_BSBA_PRODUCT_ID ON B_SALE_BASKET_ARCHIVE (PRODUCT_ID)
/
CREATE INDEX IXS_BSBA_ARCHIVE_ID ON B_SALE_BASKET_ARCHIVE (ARCHIVE_ID)
/
...
/
CREATE INDEX IXS_B_SALE_COMP_GRP_CMP_ID ON B_SALE_COMPANY_GROUP(COMPANY_ID)
/
CREATE SEQUENCE SQ_B_SALE_COMPANY_GROUP INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_COMPANY_GROUP_INSERT
BEFORE INSERT
ON B_SALE_COMPANY_GROUP
FOR EACH ROW
BEGIN
	IF :NEW.ID IS NULL THEN
 		SELECT SQ_B_SALE_COMPANY_GROUP.NEXTVAL INTO :NEW.ID FROM dual;
	END IF;
END;
/
...
/
CREATE INDEX IXS_B_SALE_COMP_RSP_GRP_CMP_ID ON B_SALE_COMPANY_RESP_GRP(COMPANY_ID)
/
CREATE SEQUENCE SQ_B_SALE_COMPANY_RESP_GRP INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
CREATE OR REPLACE TRIGGER B_SALE_COMPANY_RESP_GRP_INSERT
BEFORE INSERT
ON B_SALE_COMPANY_RESP_GRP
FOR EACH ROW
BEGIN
	IF :NEW.ID IS NULL THEN
 		SELECT SQ_B_SALE_COMPANY_RESP_GRP.NEXTVAL INTO :NEW.ID FROM dual;
	END IF;
END;
/
