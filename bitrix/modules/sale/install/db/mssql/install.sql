...
GO
ALTER TABLE B_SALE_BASKET ADD CONSTRAINT DF_B_SALE_BASKET_SORT DEFAULT '100' FOR SORT
GO
...
GO
CREATE INDEX IX_B_SALE_BASKET_7 ON B_SALE_BASKET(SET_PARENT_ID)
GO
...
(
	...
	PRICE_PAYMENT decimal(18,4) NOT NULL,
...
GO
ALTER TABLE B_SALE_ORDER ADD CONSTRAINT DF_B_SALE_ORDER_IS_RECURRING DEFAULT 'N' FOR IS_RECURRING
GO
...
GO
ALTER TABLE B_SALE_ORDER ADD CONSTRAINT DF_B_SALE_ORDER_PRICE_PAYMENT DEFAULT '0.0000' FOR PRICE_PAYMENT
GO
...
GO
CREATE INDEX IXS_DATE_PAY_BEFORE ON B_SALE_ORDER(DATE_PAY_BEFORE)
GO
...
GO
ALTER TABLE B_SALE_COMPANY2LOCATION ADD CONSTRAINT PK_B_SALE_COMPANY2LOCATION PRIMARY KEY (COMPANY_ID, LOCATION_CODE, LOCATION_TYPE)
GO
ALTER TABLE B_SALE_COMPANY2LOCATION ADD CONSTRAINT DF_B_SALE_COMPANY2LOCATION_LOCATION_TYPE DEFAULT 'L' FOR LOCATION_TYPE
GO
...
GO
ALTER TABLE B_SALE_COMPANY2SERVICE ADD CONSTRAINT PK_B_SALE_COMPANY2SERVICE PRIMARY KEY (COMPANY_ID, SERVICE_ID, SERVICE_TYPE)
GO
...
(
	...
	PREDICTIONS text NULL,
	PREDICTIONS_APP text null,
	USE_COUPONS char(1) NOT NULL,
	HAS_INDEX char(1) NOT NULL,
...
GO
ALTER TABLE B_SALE_DISCOUNT ADD CONSTRAINT DF_B_SALE_DISCOUNT_HAS_INDEX DEFAULT 'N' FOR HAS_INDEX
GO
ALTER TABLE B_SALE_DISCOUNT ADD CONSTRAINT DF_B_SALE_DISCOUNT_LAST_LEVEL_DISCOUNT DEFAULT 'N' FOR LAST_LEVEL_DISCOUNT
GO
...
(
	...
	APPLY_BLOCK_COUNTER int NOT NULL
)
GO
ALTER TABLE B_SALE_ORDER_RULES ADD CONSTRAINT PK_B_SALE_ORDER_RULES PRIMARY KEY (ID)
GO
ALTER TABLE B_SALE_ORDER_RULES ADD CONSTRAINT DF_SALE_ORD_RL_ADTL_CNT DEFAULT 0 FOR APPLY_BLOCK_COUNTER
GO
...
GO
ALTER TABLE B_SALE_ORDER_ROUND ADD CONSTRAINT PK_B_SALE_ORDER_ROUND PRIMARY KEY (ID)
GO
ALTER TABLE B_SALE_ORDER_ROUND ADD CONSTRAINT DF_SALE_ORD_RD_ABC_CNT DEFAULT 0 FOR APPLY_BLOCK_COUNTER
GO
...
CREATE TABLE B_SALE_ORDER_DELIVERY (
	...
	PARAMS TEXT NULL,
	STATUS_ID VARCHAR(2) NOT NULL,
	PRICE_DELIVERY DECIMAL(18,4) DEFAULT '0.0000' NULL,
	DISCOUNT_PRICE DECIMAL(18,4) DEFAULT '0.0000' NULL,
	BASE_PRICE_DELIVERY DECIMAL(18,4) DEFAULT '0.0000'NULL ,
	CUSTOM_PRICE_DELIVERY CHAR(1) DEFAULT 'Y' NOT NULL,
	ALLOW_DELIVERY CHAR(1) DEFAULT 'N' NULL ,
	DATE_ALLOW_DELIVERY DATETIME NULL,
	EMP_ALLOW_DELIVERY_ID INT NULL,
	DEDUCTED CHAR(1) DEFAULT 'N' NULL,
	DATE_DEDUCTED DATETIME NULL,
	EMP_DEDUCTED_ID INT NULL,
	REASON_UNDO_DEDUCTED VARCHAR(255) NULL,
	...
	CANCELED CHAR(1) DEFAULT 'N' NULL,
	DATE_CANCELED DATETIME NULL,
	EMP_CANCELED_ID INT NULL,
...
GO
ALTER TABLE B_SALE_ORDER_DELIVERY_REQ ADD CONSTRAINT PK_B_SALE_ORDER_DELIVERY_REQ PRIMARY KEY (ID)
GO
...
GO
CREATE INDEX IX_ORDER_ID ON B_SALE_ORDER_PROCESSING (ORDER_ID)
GO
...
GO
ALTER TABLE B_SALE_TP ADD CONSTRAINT PK_B_SALE_TP PRIMARY KEY (ID)
GO
CREATE UNIQUE INDEX IX_CODE ON B_SALE_TP(CODE)
GO
...
GO
ALTER TABLE B_SALE_BIZVAL ADD CONSTRAINT PK_B_SALE_BIZVAL PRIMARY KEY (CODE_KEY, CONSUMER_KEY, PERSON_TYPE_ID)
GO
...
GO
ALTER TABLE B_SALE_BIZVAL_CODE_1C ADD CONSTRAINT PK_B_SALE_BIZVAL_CODE_1C PRIMARY KEY (PERSON_TYPE_ID, CODE_INDEX)
GO
...
GO
ALTER TABLE B_SALE_SERVICE_RSTR ADD CONSTRAINT PK_B_SALE_SERVICE_RSTR PRIMARY KEY (ID)
GO
...
(
	...
	ALLOW_EDIT_SHIPMENT CHAR(1) NOT NULL
)
GO
ALTER TABLE B_SALE_DELIVERY_SRV ADD CONSTRAINT PK_B_SALE_DELIVERY_SRV PRIMARY KEY (ID)
GO
ALTER TABLE B_SALE_DELIVERY_SRV ADD CONSTRAINT DF_B_SALE_DELIVERY_SRV_ALLOW_EDIT_SHIPMENT  DEFAULT 'Y' FOR ALLOW_EDIT_SHIPMENT
GO
...
CREATE TABLE B_SALE_ORDER_PAYMENT(
	...
	PS_STATUS CHAR(1) NULL,
	PS_STATUS_CODE VARCHAR(255) NULL,
	PS_STATUS_DESCRIPTION VARCHAR(512) NULL,
...
GO
ALTER TABLE B_SALE_TP_MAP ADD CONSTRAINT PK_B_SALE_TP_MAP PRIMARY KEY (ID)
GO
CREATE UNIQUE INDEX IX_BSTPM_E_V_V ON B_SALE_TP_MAP(ENTITY_ID, VALUE_EXTERNAL, VALUE_INTERNAL)
GO
...
GO
ALTER TABLE B_SALE_TP_MAP_ENTITY ADD CONSTRAINT PK_B_SALE_TP_MAP_ENTITY PRIMARY KEY (ID)
GO
CREATE UNIQUE INDEX IX_CODE_TRADING_PLATFORM_ID ON B_SALE_TP_MAP_ENTITY(TRADING_PLATFORM_ID, CODE)
GO
...
GO
ALTER TABLE B_SALE_TP_EBAY_CAT ADD CONSTRAINT PK_B_SALE_TP_EBAY_CAT PRIMARY KEY (ID)
GO
...
GO
ALTER TABLE B_SALE_TP_EBAY_CAT_VAR ADD CONSTRAINT PK_B_SALE_TP_EBAY_CAT_VAR PRIMARY KEY (ID)
GO
...
GO
ALTER TABLE B_SALE_TP_EBAY_FQ ADD CONSTRAINT PK_B_SALE_TP_EBAY_FQ PRIMARY KEY (ID)
GO
...
GO
ALTER TABLE B_SALE_TP_EBAY_FR ADD CONSTRAINT PK_B_SALE_TP_EBAY_FR PRIMARY KEY (ID)
GO
...
GO
ALTER TABLE B_SALE_TP_ORDER ADD CONSTRAINT PK_B_SALE_TP_ORDER PRIMARY KEY (ID)
GO
CREATE UNIQUE INDEX IX_BSTPO_CODE_TRADING_PLATFORM_CODE ON B_SALE_TP_ORDER(ORDER_ID, TRADING_PLATFORM_ID, EXTERNAL_ORDER_ID)
GO
...
GO
ALTER TABLE B_SALE_GIFT_RELATED_DATA ADD CONSTRAINT PK_B_SALE_GIFT_RELATED_DATA PRIMARY KEY (ID)
GO
...
GO
ALTER TABLE B_SALE_YANDEX_SETTINGS ADD CONSTRAINT PK_B_SALE_YANDEX_SETTINGS PRIMARY KEY (SHOP_ID)
GO
...
GO
ALTER TABLE B_SALE_HDALN ADD CONSTRAINT PK_B_SALE_HDALN PRIMARY KEY (LOCATION_ID)
GO
...
GO
ALTER TABLE B_SALE_ENTITY_MARKER ADD CONSTRAINT PK_B_SALE_ENTITY_MARKER PRIMARY KEY (ID)
GO
ALTER TABLE B_SALE_ENTITY_MARKER ADD CONSTRAINT DF_B_SALE_ENTITY_MARKER_SUCCESS DEFAULT 'N' FOR SUCCESS
GO
...
GO
ALTER TABLE B_SALE_TP_VK_PROFILE ADD CONSTRAINT PK_B_SALE_TP_VK_PROFILE PRIMARY KEY (ID)
GO
...
GO
ALTER TABLE B_SALE_TP_VK_LOG ADD CONSTRAINT PK_B_SALE_TP_VK_LOG PRIMARY KEY (ID)
GO
CREATE UNIQUE INDEX IX_BSTPVKL_I_E_E ON B_SALE_TP_VK_LOG(ID, EXPORT_ID, ERROR_CODE)
GO
...
GO
ALTER TABLE B_SALE_ORDER_ARCHIVE ADD CONSTRAINT PK_B_SALE_ORDER_ARCHIVE PRIMARY KEY (ID)
GO
ALTER TABLE B_SALE_ORDER_ARCHIVE ADD CONSTRAINT DF_B_SALE_ORDER_ARCHIVE_PAYED DEFAULT 'N' FOR PAYED
GO
ALTER TABLE B_SALE_ORDER_ARCHIVE ADD CONSTRAINT DF_B_SALE_ORDER_ARCHIVE_CANCELED DEFAULT 'N' FOR CANCELED
GO
ALTER TABLE B_SALE_ORDER_ARCHIVE ADD CONSTRAINT DF_B_SALE_ORDER_ARCHIVE_DEDUCTED DEFAULT 'N' FOR DEDUCTED
GO
CREATE INDEX IXS_USER_ID ON B_SALE_ORDER_ARCHIVE(USER_ID)
GO
CREATE INDEX IXS_STATUS_ID ON B_SALE_ORDER_ARCHIVE(STATUS_ID)
GO
CREATE INDEX IXS_DATE_INSERT ON B_SALE_ORDER_ARCHIVE(DATE_INSERT)
GO
CREATE INDEX IXS_DATE_ARCHIVED ON B_SALE_ORDER_ARCHIVE(DATE_ARCHIVED)
GO
CREATE INDEX IXS_XML_ID ON B_SALE_ORDER_ARCHIVE(XML_ID)
GO
CREATE INDEX IXS_ID_1C ON B_SALE_ORDER_ARCHIVE(ID_1C)
GO
CREATE INDEX IXS_COMPANY_ID ON B_SALE_ORDER_ARCHIVE(COMPANY_ID)
GO
CREATE INDEX IXS_RESPONSIBLE_ID ON B_SALE_ORDER_ARCHIVE(RESPONSIBLE_ID)
GO
CREATE INDEX IXS_ORDER_ID ON B_SALE_ORDER_ARCHIVE(ORDER_ID)
GO
CREATE INDEX IXS_ACCOUNT_NUMBER ON B_SALE_ORDER_ARCHIVE(ACCOUNT_NUMBER)
GO
...
(
	...
	MEASURE_CODE int NULL,
	MEASURE_NAME varchar(50) null,
	BASKET_DATA text NULL
)
GO
ALTER TABLE B_SALE_BASKET_ARCHIVE ADD CONSTRAINT PK_B_SALE_BASKET_ARCHIVE PRIMARY KEY (ID)
GO
ALTER TABLE B_SALE_BASKET_ARCHIVE ADD CONSTRAINT DF_B_SALE_BASKET_ARCHIVE_QUANTITY DEFAULT '0' FOR QUANTITY
GO
CREATE INDEX IXS_PRODUCT_ID ON B_SALE_BASKET_ARCHIVE(PRODUCT_ID)
GO
CREATE INDEX IXS_ARCHIVE_ID ON B_SALE_BASKET_ARCHIVE(ARCHIVE_ID)
GO
...
GO
ALTER TABLE B_SALE_COMPANY_GROUP ADD CONSTRAINT PK_B_SALE_COMPANY_GROUP PRIMARY KEY (ID)
GO
CREATE INDEX IX_B_SALE_COMP_GRP_CMP_ID ON B_SALE_COMPANY_GROUP(COMPANY_ID)
GO
...
GO
ALTER TABLE B_SALE_COMPANY_RESP_GRP ADD CONSTRAINT PK_B_SALE_COMPANY_RESP_GRP PRIMARY KEY (ID)
GO
CREATE INDEX IX_B_SALE_COMP_RESP_GRP_CMP_ID ON B_SALE_COMPANY_RESP_GRP(COMPANY_ID)
GO
